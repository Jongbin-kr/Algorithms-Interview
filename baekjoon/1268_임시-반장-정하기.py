...
for i in range(n):
    ...
    for k in range(n):
        ...
        for grade in range(5):
            if mat[i][grade] == mat[k][grade]:
                my_friends += 1
                break
    
    if my_friends > max_friends:
        president = i
        max_friends = my_friends
...
# max_friends = 0
# president = 0   
# def get_students_j_grade_except_i_student(j_target_grade, except_i_student):
#     res = []
#     for i_student in range(n):
#         if i_student == except_i_student: continue
        
#         for j_grade in range(5):
#             if j_grade == j_target_grade: 
#                 res.append(mat[i_student][j_grade])
#     return res

# for i_student in range(n):
#     my_friends = set()
#     for j_grade in range(5):
#         my = mat[i_student][j_grade]
#         others = get_students_j_grade_except_i_student(j_grade, i_student)
#         for i, other in enumerate(others):
#             if other == my:
#                 my_friends.add(i)
    
#     if len(my_friends) > max_friends:
#         max_friends = len(my_friends)
#         president = i_student
#
# print(president+1)